...
console.log(velox.diet);

// How long was a stegosaurus?
console.log(stagosaur.length);
...
const sortUniversities = graduates.map(graduate => {
  return graduate.university;
});
const universities = sortUniversities.sort();
...
const unisWithUni = graduates.map(graduate => {
  const substring = "Uni";
  return graduate.university.includes(substring) && graduate.university;
});
